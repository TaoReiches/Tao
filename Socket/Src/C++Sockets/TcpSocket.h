...
// mark:  becouse to test server mode need more big packet so set
#define TCP_BUFSIZE_READ 64 * 1024
...
protected:
	...
	public:
		...
		/** copy l bytes from buffer to dest bu not remove**/
		bool ReadButNotRemvoe(char* dest,size_t l);
